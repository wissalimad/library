 ...
 <hr class="featurette-divider">
    ...
    <div class="container text-center text-md-start mt-5">
      <div class="row mt-3">
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <p>
            <a href="index" class="text-reset">BOOK CLUB</a>
          </p>
        </div>
        <div class="col-md-2 col-lg-5 col-xl-5 mx-auto mb-4">
          <p>
      ...
      <a href="https://www.google.co.ma/?gws_rd=ssl" class="me-4 text-reset">
  ...
  Copyright © 2023 Bibliotheque | Powered by Bibliotheque
  </div>
</footer>
</main>